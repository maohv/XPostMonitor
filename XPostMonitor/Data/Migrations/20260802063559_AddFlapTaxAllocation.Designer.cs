...
namespace XPostMonitor.Data.Migrations
{
    ...
    [Migration("20260802063559_AddFlapTaxAllocation")]
    partial class AddFlapTaxAllocation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("XPostMonitor.Models.UserTradingSettings", b =>
                {
                    ...
                    b.Property<int>("FlapHolderPercent")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("XPostMonitor.Models.WatchlistEntry", b =>
                {
                    ...
                    b.Property<bool>("CreateTokenOnPost")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("CreateTokenOnQuote")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("CreateTokenOnReply")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("CreateTokenOnRepost")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
